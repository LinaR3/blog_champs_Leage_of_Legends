...
export default function Header({ champions, items, version, favCount, onShowFavs, onSelect }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 h-14 flex items-center gap-4"
      ...
      <div className="flex items-center gap-2 mr-4">
        ...
        <span className="text-[#E8F0FF] font-['Bungee'] text-sm tracking-tight leading-none">CHAMPS_LOL</span>
      </div>
